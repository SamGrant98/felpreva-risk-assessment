...
const closePreview = () => {
  ...
  restart.classList.add('hidden-button')
  report.classList.add('hidden-button')
  group.classList.add('hidden-button')

  restart.removeEventListener('click', () => {
    window.storeData.ClearData()
  })
}
...
const showImagePreview = ({blob}) => {
  ...
  restart.classList.remove('hidden-button')
  report.classList.remove('hidden-button')
  group.classList.remove('hidden-button')
